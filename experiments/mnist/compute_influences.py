...
model.load_state_dict(
    torch.load(f"checkpoints/{args.data}_0_epoch_9.pt", map_location="cpu", weights_only=True)
)
model.eval()
...
print("Model structure before logix.watch():")
...
from logix.analysis import InfluenceFunction # Make sure to import it
